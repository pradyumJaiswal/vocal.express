...
<!-- Mirrored from wpkixx.com/html/socimo/products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 16:44:45 GMT -->
<head>
						...
						<div id="page-contents" class="row merged20">
							<div class="col-lg-9">
								<div class="main-wraper">
									<h4 class="main-title">Market</h4>
									<ul class="category">
										<li><a class="active" href="#" title="">Suggestions</a></li>
									...
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-1.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$23</span>
													<a href="product-detail.html" title="">Men's watch</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 3.3k</li>
														<li><i class="icofont-thumbs-up"></i> 10k</li>
													</ul>
												</div>	
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-2.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$10</span>
													<a href="product-detail.html" title="">HP Elite Book</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 3.3k</li>
														<li><i class="icofont-thumbs-up"></i> 20k</li>
													</ul>
												</div>	
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-3.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$13</span>
													<a href="product-detail.html" title="">Jubli Headphone</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 1.3k</li>
														<li><i class="icofont-thumbs-up"></i> 5k</li>
													</ul>
												</div>	
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-4.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$55</span>
													<a href="product-detail.html" title="">Office Chair</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 4.0k</li>
														<li><i class="icofont-thumbs-up"></i> 1k</li>
													</ul>
												</div>	
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-5.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$60</span>
													<a href="product-detail.html" title="">New Iphone Mobile</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 7.2k</li>
														<li><i class="icofont-thumbs-up"></i> 23k</li>
													</ul>
												</div>	
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-6.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$30</span>
													<a href="product-detail.html" title="">LEd GL 2022</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 1.1k</li>
														<li><i class="icofont-thumbs-up"></i> 2k</li>
													</ul>
												</div>	
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-7.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$09</span>
													<a href="product-detail.html" title="">Android Mobile</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 3.3k</li>
														<li><i class="icofont-thumbs-up"></i> 20k</li>
													</ul>
										...
										<div class="col-lg-4 col-md-4 col-sm-12">
											<div class="market-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-8.jpg" alt=""></a></figure>
												<div class="prod-info">
													<span>$39</span>
													<a href="product-detail.html" title="">Home Appliences</a>
													<ul class="like-meta">
														<li><i class="icofont-eye-open"></i> 3.3k</li>
														<li><i class="icofont-thumbs-up"></i> 20k</li>
													</ul>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="big-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-ad-2.jpg" alt=""></a></figure>
												<div class="big-deals">
													<ins>Limited Time Only</ins>
													<h4>60% Flat Off</h4>
													<p>Eiusmod sit amet tempor incidunt sed diam nonummy nibh euismod</p>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="big-post mb-4">
												<figure><a href="product-detail.html" title=""><img src="images/resources/product-ad-1.jpg" alt=""></a></figure>
												<div class="big-deals">
													<ins>Start From $5.00</ins>
													<h4>Fresh Produce Products</h4>
													<p>Eiusmod sit amet tempor incidunt sed diam nonummy nibh euismod</p>
													<a href="#" title="">Shop Now</a>
												</div>
											</div>
								...
								<div class="main-wraper">
									...
									<div class="market-categories">
										<div class="book-post align-center">
											<figure><a href="#" title=""><img src="images/resources/product-1.jpg" alt=""></a></figure>
											<a href="#" title="">Watches</a>
										</div>
										<div class="book-post align-center">
											<figure><a href="#" title=""><img src="images/resources/product-2.jpg" alt=""></a></figure>
											<a href="#" title="">Laptops</a>
										</div>
										<div class="book-post align-center">
											<figure><a href="#" title=""><img src="images/resources/product-3.jpg" alt=""></a></figure>
											<a href="#" title="">Headphone</a>
										</div>
										<div class="book-post align-center">
											<figure><a href="#" title=""><img src="images/resources/product-4.jpg" alt=""></a></figure>
											<a href="#" title="">Office Chairs</a>
										</div>
										<div class="book-post align-center">
											<figure><a href="#" title=""><img src="images/resources/product-5.jpg" alt=""></a></figure>
											<a href="#" title="">Mobiles</a>
										</div>
									</div>
								</div>
							</div>
...
<!-- Mirrored from wpkixx.com/html/socimo/products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 16:44:48 GMT -->
</html>