...
<!-- Mirrored from wpkixx.com/html/socimo/development-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 16:44:41 GMT -->
<head>
                    ...
                    <li>
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <button class="button primary circle">default </button>


                                <h4 class="uk-margin-medium-top"> Basic Size </h4>

                                    <p uk-margin>
                                        <button class="button primary small">small </button>
                                        <button class="button primary">default </button>
                                        <button class="button primary large">Large </button>
                                        <button class="button primary xlarge">Large </button>
                                    </p>
...
<span class="hljs-tag">&lt;<span class="hljs-name">button</span>  <span class="hljs-attr">class</span>=<span class="hljs-string">"button xlarge"</span>&gt;</span>xlarge<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></pre>
                                    ...
                                    <h4 id="Button-colors" class="uk-margin-medium-top"> Button Colors </h4>
                                        ...
                                        <h4 id="Button-outline" class="uk-margin-medium-top"> Outline Button</h4>
                                            ...
                                            <div class="uk-margin">
                                                <button type="button" class="button outline-primary">primary</button>
                                            ...
                                            <br>
                                            <pre
                                                class="bg-light"> <span class="hljs-tag">&lt;<span class="hljs-name">button</span>  <span class="hljs-attr">class</span>=<span class="hljs-string">"button outline-primary"</span>&gt;</span>primary<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></pre>


                                            <h4 id="Button-soft" class="uk-margin-medium-top"> Soft color</h4>

                                                <div class="uk-margin">
                                                    <button type="button" class="button soft-primary">primary</button>
                                                    <button type="button" class="button soft-secondary">Secondary</button>
                                                ...
                                                <br>
                                                <pre
                                                    class="bg-light"> <span class="hljs-tag">&lt;<span class="hljs-name">button</span>  <span class="hljs-attr">class</span>=<span class="hljs-string">"button  soft-primary"</span>&gt;</span>primary<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></pre>


                                                <p class="mt-md">add <code>.disabled</code>to make disable </p>

                                                <div class="uk-margin">
                                                    <button type="button" class="button soft-primary disabled">primary</button>
                                                    <button type="button" class="button soft-secondary disabled">Secondary</button>
                                                    <button type="button" class="button soft-success disabled">Success</button>
                                                    <button type="button" class="button soft-info disabled">info</button>
                                                    <button type="button" class="button soft-danger disabled">Danger</button>
                                                    <button type="button" class="button soft-light disabled">Light</button>
                                                    <button type="button" class="button soft-dark disabled">Dark</button>
                                                </div>
                                                <br>
                                                <pre
                                                    class="bg-light"> <span class="hljs-tag">&lt;<span class="hljs-name">button</span>  <span class="hljs-attr">class</span>=<span class="hljs-string">"button soft-primary disabled"</span>&gt;</span>Soft primary<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></pre>



                                                <h4 id="transtion" class="uk-margin-medium-top">Button transition 3d hover</h4>

                                                    <div class="uk-margin">
                                                        <button type="button"
                                                            class="button primary transition-3d-hover">primary</button>
                                                        <button type="button"
                                                    ...
                                                    <br>
                                                    <pre
                                                        class="bg-light"> <span class="hljs-tag">&lt;<span class="hljs-name">button</span>  <span class="hljs-attr">class</span>=<span class="hljs-string">"button primary transition-3d-hover"</span>&gt;</span>Soft primary<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></pre>



                                                    <h4 id="Button-Social" class="uk-margin-medium-top">Button Social</h4>
                                                        ...
                                                        <h4 id="btn-with-icon" class="uk-margin-medium-top" aria-hidden="false">Button with icon </h4>

                                                            <div class="uk-margin">
                                                                <button type="button" class="button primary icon-label">
                                                                    <span class="inner-icon"><i class="icofont-ui-play"></i></span>
                                                                    <span class="inner-text">Play now</span>
                                                                </button>
                                                                <button type="button"
                                                                    class="button primary icon-label bg-facebook">
                                                                    <span class="inner-icon"><i class="icofont-facebook"></i></span>
                                                                    <span class="inner-text">Facebook</span>
                                                                </button>
                                                                <button type="button" class="button success icon-label">
                                                                    <span class="inner-icon"><i class="icofont-cart-alt"></i></span>
                                                                    <span class="inner-text">Add to cart</span>
                                                                </button>
                                                                <button type="button" class="button danger icon-label">
                                                                    <span class="inner-icon"><i class="icofont-trash"></i></span>
                                                            ...
                                                            <div class="uk-margin">
                                                                <button type="button" class="button dark icon-label">
                                                                    ...
                                                                    <span class="inner-icon"> <i class="icofont-simple-right"></i>
                                                                    </span>
                                                                </button>
                                                                <button type="button"
                                                                    class="button secondary icon-label">
                                                                    <span class="inner-text">Add to cart</span>
                                                                    <span class="inner-icon"> <i class="icofont-ui-cart"></i>
                                                                    </span>
                                                                </button>
                                                                <button type="button" class="button danger icon-label">
                                                                    <span class="inner-text">Delete item</span>
                                                                    <span class="inner-icon"> <i class="icofont-ui-delete"></i>
                                                                    </span>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="uk-margin">
                                                                ...
                                                                <button
                                                                    class="button outline-primary transition-3d-hover">
                                                                    <i class="icofont-cash-on-delivery-alt"></i> Buy
                                                                    now
                                                                </button>

                                                                <button class="button primary transition-3d-hover">
                                                                    <i class="icofont-close-line"></i> Delete
                                                                </button>

                                                            </div>


                                                            <h4 id="btn-animation" class="uk-margin-medium-top">Button with icon animation</h4>

                                                                <div class="uk-margin">
                                                                    <button type="button"
                                                                        class="button primary animated-x">
                                                                        <span class="inner-visible">Next step</span>
                                                                        <span class="inner-hidden"><i class="icofont-arrow-right"></i>
                                                                        </span>
                                                                    </button>
                                                                    <button type="button"
                                                                        class="button secondary animated-y">
                                                                        <span class="inner-hidden">Buy</span>
                                                                        <span class="inner-visible"><i class="icofont-shopping-cart"></i></span>
                                                                    </button>
                                                                </div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></code></pre>
                                                                ...
                                                                <div class="uk-margin-medium-top"
                                                                    ...
                                                                    <div class="uk-margin">
                                                                        ...
                                                                        <span class="iconbox button primary">
                                                                        ...
                                                                        <span class="iconbox button primary circle">
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
     ...
     <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
     <span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
         <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"uk-card-default uk-card-body bg-primary uk-light"</span>&gt;</span>
             <span class="hljs-tag">&lt;<span class="hljs-name">h5</span>&gt;</span> Default <span class="hljs-tag">&lt;/<span class="hljs-name">h5</span>&gt;</span>
             <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Lorem ipsum dolor sit amet, consectetur adipisicing elit.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
         <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
     <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
                                    ...
                                    <div class="uk-card-header">
                                        <div class="uk-grid-small uk-flex-middle" uk-grid>
                                            <div class="uk-width-auto">
                                                <img class="uk-border-circle" src="images/elements/user-avatar.jpg" alt="" style="width:40px">
                                            </div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #Card-media2"> MARKUP</button>

                                    <div id="Card-media2" aria-hidden="true" class=" uk-margin-small-top" hidden="">
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin"
                                    ...
                                    <div class="uk-card-media-left uk-cover-container">
                                        <img src="images/elements/image.jpg" alt="" uk-cover>
                                ...
                                <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin"
                                    ...
                                    <div class="uk-flex-last@s uk-card-media-right uk-cover-container">
                                        <img src="images/elements/dark.jpg" alt="" uk-cover>
                                        <canvas width="600" height="400"></canvas>
                                    </div>
                                    <div>
                                        <div class="uk-card-body">
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <h4 id="Uikit-backgrounds">Uikit backgrounds</h4>
                                    ...
                                    <p>To apply a background color to an element, add one of the following classes :
                                        ...
                                        <code class="mr-2"> .bg-primary </code> <code class="mr-2"> .bg-info </code>
                                    ...
                                    <p>To apply a background color to an element, add one of the following classes :
                                        ...
                                        <code class="mr-2"> .bg-soft-primary </code> <code class="mr-2"> .bg-soft-info
                                    ...
                                    <div class="uk-child-width-1-4@s uk-text-center uk-flex-center" uk-grid>
                                        <span class="text-muted">.uk-text-muted</span>
                                        <span class="text-emphasis">.uk-text-emphasis</span>
                                        <span class="text-primary">.uk-text-primar</span>
                                        <span class="text-secondary">.uk-text-secondary</span>
                                        <span class="text-success">.uk-text-success</span>
                                        <span class="text-primary">.uk-text-primary</span>
                                        <span class="text-info">.uk-text-info</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top" id="flex-h-alignment"> Horizontal alignment </h3>
                                ...
                                <div class="mt-lg-4">
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #f-Horizontal"> MARKUP</button>

                                    <div id="f-Horizontal" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top" id="flex-v-alignment">Vertical alignment </h3>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div class="uk-flex-middle" uk-grid>
                                    ...
                                    <div class="uk-width-1-3@m uk-flex-first">
                                        <img src="images/elements/image.jpg" alt="Image">
                                    </div>
                                </div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span></code></pre>
                                ...
                                <div>
                                    <button class="button Markup-botton uk-margin-small-top" type="button"
                                        uk-toggle="target: #Frm-and-icons"> MARKUP</button>

                                    <div id="Frm-and-icons" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span></code></pre>
                                ...
                                <div>
                                    <button class="button Markup-botton uk-margin-small-top" type="button"
                                        uk-toggle="target: #Frm-and-grid"> MARKUP</button>

                                    <div id="Frm-and-grid" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div>
                                    ...
                                    <div id="Gird-Gutter-3" aria-hidden="true" class=" uk-margin-small-top" hidden="">
                                        <pre><code id="code-jw0flkmc" class="lang-html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"uk-grid-medium uk-child-width-expand@s uk-text-center"</span> <span class="hljs-attr">uk-grid</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"uk-card uk-card-default uk-card-body"</span>&gt;</span>Item<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
                    ...
                    <li>
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #headingbasic"> MARKUP</button>

                                    <div id="headingbasic" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;<span class="hljs-name">h1</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"uk-heading-line uk-text-right"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span>&gt;</span>Heading Line<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">h1</span>&gt;</span></code></pre>
                                ...
                                <pre><code id="code-jw0flortt" class="lang-html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">h1</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"uk-divider-small"</span>&gt;</span>Heading Text<span class="hljs-tag">&lt;/<span class="hljs-name">h1</span>&gt;</span></code></pre>
                    ...
                    <li>
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <p id="list-intro" class="mb-4"> To apply this component, add the
                                    <code>.uk-list</code>
                                    class to
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top" id="list-bullet">Bullet modifier </h3>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top" id="list-devider">Divider modifier </h3>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top" id="list-striped">Striped modifier </h3>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top" id="list-large">Large modifier </h3>
                    ...
                    <li>
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <p class="pager-intro">The Pagination component consists of button-like styled links,
                    ...
                    <li>
                        ...
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #pos-basic"> MARKUP</button>

                                    <div id="pos-basic" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #pos-directions"> MARKUP</button>

                                    <div id="pos-directions" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #utside"> MARKUP</button>

                                    <div id="utside" aria-hidden="true" class="uk-margin-small-top" hidden>
                    ...
                    <li>
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #table-basic"> MARKUP</button>

                                    <div id="table-basic" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">table</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top " id="table-divider"> Divider modifier </h3>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">table</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top " id="table-striped"> Striped modifier </h3>
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #tab-striped"> MARKUP</button>

                                    <div id="tab-striped" aria-hidden="true" class="uk-margin-small-top" hidden>
                    ...
                    <li>
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #tabs-basic"> MARKUP</button>

                                    <div id="tabs-basic" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                                ...
                                <h3 class=" uk-margin-medium-top " id="tab-bottom-modifier"> Bottom modifier </h3>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <h3 class=" uk-margin-medium-top " id="tab-alignment">Alignment </h3>
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #item-alignment"> MARKUP</button>

                                    <div id="item-alignment" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #Tab-and-Dropdown"> MARKUP</button>

                                    <div id="Tab-and-Dropdown" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                                ...
                                <h3 class="uk-margin-medium-top" id="light-Tabs"> Advance Light Tabs</h3>

                                <p> <code>.uk-light</code> to change your tabs to Light and <a href="colors.html">
                                        background
                                        compunents </a> </p>

                                <div class="uk-light bg-dark pd-20">
                                ...
                                <p> Tabs can be used to trigger a dropdown menu from the 
									<a href="dropdown.html">Dropdown component</a>
								</p>
                                <div class="bg-blue uk-light uk-padding pb-0 rounded shadow">
                                    <h2>Awesome Title</h2>
                                ...
                                <h3 class="uk-margin-medium-top " id="tab-width-icon"> Tab with icon</h3>

                                <div uk-grid>
                                    <div class="uk-width-1-3@m">
                                        <ul class="uk-tab-right shadow p-3 pl-0"
                                            uk-tab="connect: #component-tab-right; animation: uk-animation-fade">
                                            <li class="uk-active"><a href="#"> <i class="icofont-home mr-2"></i>Home</a></li>
                                            <li><a href="#"> <i class="icofont-comment mr-2"></i>convention</a></li>
                                            <li><a href="#"> <i class="icofont-gear mr-2"></i> settings</a></li>
                                        </ul>
                                    </div>
                                    <div class="uk-width-expand@m">
                    ...
                    <li>
                        <div class="mt-4 uk-grid-large" uk-grid>
                            ...
                            <div class="uk-width-3-4@s">
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #Text-wraping"> MARKUP</button>

                                    <div id="Text-wraping" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                                ...
                                <div class="uk-child-width-1-3@m uk-child-width-1-2@s mt-3" uk-grid>
                                    <div>
                                        <img src="images/elements/avatar-1.jpg" alt="" width="50" height="50">
                                        <span class="uk-text-top">Lorem ipsum.</span>
                                    </div>
                                    <div>
                                        <img src="images/elements/avatar-2.jpg" alt="" width="50" height="50">
                                        <span class="uk-text-middle">Lorem ipsum.</span>
                                    </div>
                                    <div>
                                        <img src="images/elements/avatar-3.jpg" alt="" width="50" height="50">
                                ...
                                <div>
                                    <button class="Markup-botton button uk-margin-small-top" type="button"
                                        uk-toggle="target: #Vert-alignment"> MARKUP</button>

                                    <div id="Vert-alignment" aria-hidden="true" class="uk-margin-small-top" hidden>
...
<!-- Mirrored from wpkixx.com/html/socimo/development-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 16:44:45 GMT -->
</html>
