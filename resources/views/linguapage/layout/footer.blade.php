...
<script src="{{asset('user/lingua/js/jquery-3.2.1.min.js')}}"></script>
<script src="{{asset('user/lingua/styles/bootstrap4/popper.js')}}"></script>
<script src="{{asset('user/lingua/styles/bootstrap4/bootstrap.min.js')}}"></script>
<script src="{{asset('user/lingua/plugins/OwlCarousel2-2.2.1/owl.carousel.js')}}"></script>
<script src="{{asset('user/lingua/plugins/easing/easing.js')}}"></script>
<script src="{{asset('user/lingua/js/custom.js')}}"></script>

<script src="{{asset('user/lingua/js/contact.js')}}"></script>
<script src="{{asset('user/lingua/plugins/easing/easing.js')}}"></script>
<script src="{{asset('user/lingua/plugins/parallax-js-master/parallax.min.js')}}"></script>
