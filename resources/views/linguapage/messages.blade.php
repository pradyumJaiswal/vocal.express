									...
									<div class="message-box">
										<div class="message-header">
											<div class="useravatar active">
												<img src="{{asset('user/images/resources/friend-avatar.jpg')}}" alt="">
												<span>Oliver</span>
												<div class="status away"></div>
											</div>
											<div class="useravatar">
												<img src="{{asset('user/images/resources/friend-avatar2.jpg')}}" alt="">
												<span>Sarah</span>
												<div class="status online"></div>
											</div>
											<div class="useravatar">
												<img src="{{asset('user/images/resources/friend-avatar3.jpg')}}" alt="">
												<span>Andrew</span>
												<div class="status offline"></div>
											</div>
											<div class="useravatar">
												<img src="{{asset('user/images/resources/friend-avatar4.jpg')}}" alt="">
												<span>Mikaly</span>
												<div class="status online"></div>
											</div>
											<div class="useravatar">
												<img src="{{asset('user/images/resources/friend-avatar5.jpg')}}" alt="">
												<span>Bumsy</span>
												<div class="status away"></div>
											</div>
											<div class="useravatar">
										...
										<div class="message-content">
											...
											<div class="chat-content">
												...
												<div class="message-text-container">
													...
													<form method="post">
														<span class="emojie"><img src="{{asset('user/images/smiles/happy.png')}}" alt=""></span>
														...
														<div class="smiles-bunch">
															...
															<i><img src="{{asset('user/images/smiles/bored-2.png')}}" alt=""></i>
															<i><img src="{{asset('user/images/smiles/bored.png')}}" alt=""></i>
															<i><img src="{{asset('user/images/smiles/confused-1.png')}}" alt=""></i>
															<i><img src="{{asset('user/images/smiles/confused.png')}}" alt=""></i>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone-call"><path d="M15.05 5A5 5 0 0 1 19 8.95M15.05 1A9 9 0 0 1 23 8.94m-1 7.98v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
								...
								<div class="short-intro">
									<figure><img src="{{asset('user/images/resources/album1.jpg')}}" alt=""></figure>
									<ul>
										<li>
										...
										<li>
											...
											<p><a href="https://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1f4c7e726f737a5f78727e7673317c7072">[email&#160;protected]</a></p>
										</li>
										<li>
...
<!-- Mirrored from wpkixx.com/html/socimo/messages.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 16:43:58 GMT -->
</html>