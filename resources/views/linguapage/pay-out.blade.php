							...
							<div class="widget">
								...
								<div class="card-credit">
									...
									<div class="happy-spend">
										<p><img src="{{asset('user/images//smiles/smiling.png')}}" alt=""> Happy spending for the Next Month</p>
									</div>
								</div>
							</div>
							<div class="widget">
						...
						<div class="main-wraper">
							...
							<table class="table table-default table-responsive-md table-striped">
								...
								<tbody>
									<tr>
										<td>Thursday, 1</td>
										<td><img src="{{asset('user/images//flags/001-united-kingdom.png')}}" alt=""></td>
									...
									<tr>
										<td>Firday, 2</td>
										<td><img src="{{asset('user/images//flags/002-united-states.png')}}" alt=""></td>
									...
									<tr>
										<td>Saturday, 3</td>
										<td><img src="{{asset('user/images//flags/003-france.png')}}" alt=""></td>
									...
									<tr>
										<td>Monday, 5</td>
										<td><img src="{{asset('user/images//flags/004-germany.png')}}" alt=""></td>
									...
									<tr>
										<td>Tuesday, 6</td>
										<td><img src="{{asset('user/images//flags/005-spain.png')}}" alt=""></td>
									...
									<tr>
										<td>Wednesday, 7</td>
										<td><img src="{{asset('user/images//flags/006-china.png')}}" alt=""></td>
									...
									<tr>
										<td>Thursday, 8</td>
										<td><img src="{{asset('user/images//flags/007-italy.png')}}" alt=""></td>
										<td><a href="#" title="">Laravel Advance Online</a></td>
										<td>10</td>
										<td>$15.67</td>
									</tr>
									<tr>
										<td>Friday, 9</td>
										<td><img src="{{asset('user/images//flags/008-japan.png')}}" alt=""></td>
										<td><a href="#" title="">Basic PHP laravel Course</a></td>
										<td>16</td>
										<td>$15.67</td>
									</tr>
									<tr>
										<td>Saturday, 10</td>
										<td><img src="{{asset('user/images//flags/009-brazil.png')}}" alt=""></td>
										<td><a href="#" title="">Laravel Advance Online</a></td>
										<td>13</td>
										<td>$15.67</td>
									</tr>
									<tr>
										<td>Sunday, 11</td>
										<td><img src="{{asset('user/images//flags/010-south-korea.png')}}" alt=""></td>
										<td><a href="#" title="">Css3 Advacne Book</a></td>
										<td>2</td>
										<td>$15.67</td>
									</tr>
...
<!-- Mirrored from wpkixx.com/html/socimo/pay-out.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 16:43:39 GMT -->
</html>