...
<!-- Mirrored from wpkixx.com/html/socimo/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 16:44:17 GMT -->
<head>
...
<div class="theme-layout">
	<div class="coming-page">
		...
		<div class="comesoon-wraper">
				<div class="logo top-left"><img src="images/logo.png" alt=""><span>Socimo</span></div>
				<div class="top-right">
				...
				<div class="right-bottom">
					<span>Follow Us</span>
					<ul>
						<li><a href="#" title=""><i class="icofont-facebook"></i></a></li>
						<li><a href="#" title=""><i class="icofont-twitter"></i></a></li>
						<li><a href="#" title=""><i class="icofont-instagram"></i></a></li>
						<li><a href="#" title=""><i class="icofont-whatsapp"></i></a></li>
					</ul>
				</div>
			</div>
	</div>	
